            ...
            {#each desktopNavItems as item}
              <li>
                <a class="navLink" href={item.href}>
                  ...
                  {#if item.dot}
                    <span class="hasUnreadArticles" aria-hidden="true"></span>
                  {/if}
                  {#if item.caret}
                    <span class="arrowWidget" aria-hidden="true"></span>
                  {/if}
                </a>
              </li>
            {/each}
...
<style>
  ...
  .QuickSearchQuery::-webkit-search-cancel-button,
